...
<body>
	...
	<div style="width: 800px; margin: 0 auto;">
		...
		<span style="font-family: 'Open Sans', sans-serif;color: #999;">${news.publisher}</span>
		
		<h4 style="font-family: 'Raleway', sans-serif;display: inline-block;padding: 0 0 50px 300px">发布时间：</h4>
		<span style="font-family: 'Open Sans', sans-serif;color: #999;">${news.newsCreate}</span>

		<div style="width: 700px; margin: 0 auto;">
			${news.newsContent}
			<h4 style="font-family: 'Raleway', sans-serif;display: inline-block; padding: 50px 0">最后修改于：</h4>
			<span style="font-family: 'Open Sans', sans-serif;color: #999;">${news.newsModified}</span>
